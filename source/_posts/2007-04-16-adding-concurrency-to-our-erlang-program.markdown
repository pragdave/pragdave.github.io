...
<img src="https://31.media.tumblr.com/832a349f4f0d9156fec96948a38c99f6/tumblr_inline_my11e0Qu9I1rgo2z9.jpg"/>
...
So, do you have to go to all this trouble to make your Erlang code run in parallel? Not really. I just wanted to show some of the nuts and bolts. In reality, you’d probably use a library method, such as the`pmap` function that Joe wrote for the <a href="http://pragmaticprogrammer.com/titles/jaerlang/index.html">Programming Erlang</a> book. Armed with this, you could turn the serial fetch program to a parallel fetch program by changing
